...
/* get ID sent in - which is sales ID.  This will be hardcoded for now */
$salesId=1;
$titleId='ID'.$salesId;

/* initialize all form data upon entry */
...
<html>
    ...
    <div class= "main">
        ...
        <div id="viewTitle">
        <p class="mainTitle" id= <?php echo $titleId; ?> >Task Entry Form For Sales Lead Id: <?php echo '  '.$salesId; ?></p><br>
        </div>
    ...
    <div class="scrollTableInput">
        ...
        <tbody id="main_table"> <!-- Body of Data -->
        </tbody>
        </table>
    <br>
    <br>
    ...
    <div class="mainFormProjectInput">
        <!-- form entry -->          
    <!--<form action="addNewProject1.php" method="post" name="addNewProjectForm" onsubmit="return validateForm(this,'addNewTaskForm');" >   -->
    ...
    <div id="leftInfoAddSmall">
        ...
        <select id='proposal_lead_id' name="proposal_lead" class="formInputMedium">
            <!--<?php createSelectHTML($employeeListArray,'id','name_first','name_last',$proposal_lead_id,'');?> -->
